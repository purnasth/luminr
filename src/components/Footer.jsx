...
const Footer = () => {
  return (
    <>
      <footer className="bg-luminr-blue pt-48 pb-0 overflow-hidden">
        ...
        <div className="container max-w-7xl -translate-y-32">
          ...
          <div className="bg-luminr-white backdrop-blur-md rounded-3xl flex flex-col text-luminr-blue gap-20 justify-between px-10 py-16 z-10">
            <div class="flex flex-row gap-8 mx-auto">
              <svg
                class="lg:h-48 w-64 lg:w-auto"
                viewBox="0 0 499 189"
                fill="none"
              ...
              <svg
                class="lg:w-56 hidden lg:inline-block"
                viewBox="0 0 213 181"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <div className="flex lg:flex-row flex-col gap-10 lg:gap-0 lg:justify-between">
              <ul className="text-luminr-blue transition-all text-2xl font-medium tracking-wide">
                {[
                  {
                    icon: (
