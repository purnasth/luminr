...
const Appointment = () => {
  return (
    <>
      <button class="group relative rounded-full p-px text-base font-semibold leading-6 shadow-xl shadow-zinc-950 text-luminr-white">
        ...
        <div class="relative z-10 rounded-full bg-gradient-to-b from-zinc-800 to-zinc-900 py-1 px-4 ring-1 ring-white/10 flex items-center space-x-2">
